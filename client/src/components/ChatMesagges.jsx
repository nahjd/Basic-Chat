      ...
      <div className="w-full border mt-4 mb-4 h-[550px] rounded-md p-3 overflow-y-auto flex flex-col-reverse relative">
        {messages
          ...
          .map((message) => (
            <div
              key={message.id}
              className={`box w-fit max-w-[45%] flex flex-col mb-3 ${userId === message?.userId && "ml-auto"
                }`}
            >
              <div
                className={`w-full flex flex-wrap break-words p-1 px-2 rounded-md ${userId === message?.userId
                  ? "bg-black text-white"
                  : "bg-gray-200"
                  }`}
              >
              ...
              <span
                className={`px-2 text-[12px] text-gray-500 ${userId === message?.userId && "text-end"
                  }`}
              >
                {message?.time}
              </span>
